            ...
            <div class="row multi-columns-row">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="features-item">
                  ...
                  <p>The modern man is usually in a hurry to get to a destination from which he will sooner or later suffer from and at times complain about boredom.</p>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="features-item">
                  ...
                  <p>Changing lanes quickly, often without signaling. "I have got the most prioritised job to be done".</p>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="features-item">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="features-item">
                  ...
                  <p>Remember you can’t control traffic or other drivers, but you CAN control your attitude and reaction to them.</p>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="features-item">
                  ...
                  <p>If someone is driving aggressively, safely get out of the other vehicle’s way and do not react to the driver’s behavior. </p>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="features-item">
                  ...
                  <p>You want to keep cool, calm, and collected. If the aggressive driving persists, or you feel you are in danger, do not hesitate to call 911 for help.</p>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="features-item">
